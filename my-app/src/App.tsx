...
const App: React.FC = () => {
  // State variables
  const [prize] = useState<string>("A Luxurious Getaway");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 text-[#31081f] font-sans antialiased flex flex-col">
      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center flex-grow">
        {/* Added flex-grow */}
        ...
        <main className="rounded-3xl shadow-2xl bg-white/80 backdrop-blur-md py-8 px-4 sm:py-12 sm:px-6 lg:px-16 w-full max-w-md">
